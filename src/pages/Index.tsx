...
const Index = () => {
  ...
  return (
    <div className="bg-white">
      ...
      {/* How it works section - Black background with center-aligned items */}
      <div id="how-it-works" className="bg-black text-white py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
            ...
            <div className="mt-16 text-center">
              <Link
                ...
                className="inline-flex items-center rounded-md bg-white px-6 py-3 text-sm font-semibold text-black shadow-sm hover:bg-gray-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
              >
      ...
      {/* CTA section - Black background with centered content */}
